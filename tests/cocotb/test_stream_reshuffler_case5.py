...
CSR_LOOP_COUNT_2 = 2 + STREAMER_OFFSET
CSR_LOOP_COUNT_3 = 3 + STREAMER_OFFSET
CSR_TEMPORAL_STRIDE_M0_L0 = 4 + STREAMER_OFFSET
CSR_TEMPORAL_STRIDE_M0_L1 = 5 + STREAMER_OFFSET
CSR_TEMPORAL_STRIDE_M0_L2 = 6 + STREAMER_OFFSET
CSR_TEMPORAL_STRIDE_M0_L3 = 7 + STREAMER_OFFSET
CSR_TEMPORAL_STRIDE_M1_L0 = 8 + STREAMER_OFFSET
CSR_TEMPORAL_STRIDE_M1_L1 = 9 + STREAMER_OFFSET
CSR_TEMPORAL_STRIDE_M1_L2 = 10 + STREAMER_OFFSET
CSR_TEMPORAL_STRIDE_M1_L3 = 11 + STREAMER_OFFSET
CSR_SPATIAL_STRIDE_M0 = 12 + STREAMER_OFFSET
CSR_SPATIAL_STRIDE_M1 = 13 + STREAMER_OFFSET
CSR_BASE_PTR_M0 = 14 + STREAMER_OFFSET
CSR_BASE_PTR_M1 = 15 + STREAMER_OFFSET
CSR_START_STREAMER = 16 + STREAMER_OFFSET
...
async def stream_reshuffler_dut(dut):
    ...
    LOOP_COUNT_1 = TRANSFORMATION_PARAMS['strides'][-2]['bound']
    LOOP_COUNT_2 = TRANSFORMATION_PARAMS['strides'][-3]['bound']
    ...
    narrow_golden_list = snax_util.gen_rand_int_list(
        int(LOOP_COUNT_0 * LOOP_COUNT_1 * LOOP_COUNT_2 * LOOP_COUNT_3), MIN_VAL, MAX_VAL
    )
...
def test_stream_reshuffler(simulator, waves):
    ...
    module = "test_stream_reshuffler_case5"
