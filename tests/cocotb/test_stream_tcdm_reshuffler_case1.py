...
CSR_LOOP_COUNT_0 = 0
CSR_TEMPORAL_STRIDE_M0_L0 = 1
CSR_TEMPORAL_STRIDE_M1_L0 = 2
CSR_SPATIAL_STRIDE_M0 = 3
CSR_SPATIAL_STRIDE_M1 = 4
CSR_BASE_PTR_M0 = 5
CSR_BASE_PTR_M1 = 6
CSR_START_STREAMER = 7
...
async def stream_tcdm_dut(dut):
    ...
    BASE_PTR_M1 = NR_BANKS * math.ceil(LOOP_COUNT_0 * ALIGN_ELEMS / NR_BANKS) + OFFSET
    # BASE_PTR_M1 = 128
    ...
    for i in range(LOOP_COUNT_0):
        ...
        # Note that each reader port is 256 bits only  << 64 bits only
        ...
        # snax_util.comp_and_assert((wide_golden_list[i] & ((1 << 64) - 1)), read_stream_0)
    ...
    for i in range(LOOP_COUNT_0):
        ...
        snax_util.comp_and_assert(narrow_writer_golden_list[i], read_stream_0)
        await snax_util.clock_and_wait(dut)
...
def test_stream_tcdm(simulator, waves):
    ...
    streamer_cfg_file = "streamer_cfg_reshuffler_case1.hjson"
    ...
    module = "test_stream_tcdm_reshuffler_case1"
