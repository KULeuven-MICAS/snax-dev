...
CSR_TEMPORAL_STRIDE_M0_L0 = 3 + STREAMER_OFFSET
CSR_TEMPORAL_STRIDE_M0_L1 = 4 + STREAMER_OFFSET
CSR_TEMPORAL_STRIDE_M0_L2 = 5 + STREAMER_OFFSET
CSR_TEMPORAL_STRIDE_M1_L0 = 6 + STREAMER_OFFSET
CSR_TEMPORAL_STRIDE_M1_L1 = 7 + STREAMER_OFFSET
CSR_TEMPORAL_STRIDE_M1_L2 = 8 + STREAMER_OFFSET
CSR_SPATIAL_STRIDE_M0 = 9 + STREAMER_OFFSET
CSR_SPATIAL_STRIDE_M1 = 10 + STREAMER_OFFSET
CSR_BASE_PTR_M0 = 11 + STREAMER_OFFSET
CSR_BASE_PTR_M1 = 12 + STREAMER_OFFSET
CSR_START_STREAMER = 13 + STREAMER_OFFSET
...
async def stream_reshuffler_dut(dut):
    ...
    narrow_golden_list = snax_util.gen_rand_int_list(
        int(LOOP_COUNT_0 * LOOP_COUNT_1 * LOOP_COUNT_2), MIN_VAL, MAX_VAL
    )
...
def test_stream_reshuffler(simulator, waves):
    ...
    module = "test_stream_reshuffler_case4"
