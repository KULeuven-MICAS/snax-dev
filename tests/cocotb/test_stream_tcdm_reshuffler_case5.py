...
CSR_LOOP_COUNT_2 = 2
CSR_LOOP_COUNT_3 = 3
CSR_TEMPORAL_STRIDE_M0_L0 = 4
CSR_TEMPORAL_STRIDE_M0_L1 = 5
CSR_TEMPORAL_STRIDE_M0_L2 = 6
CSR_TEMPORAL_STRIDE_M0_L3 = 7
CSR_TEMPORAL_STRIDE_M1_L0 = 8
CSR_TEMPORAL_STRIDE_M1_L1 = 9
CSR_TEMPORAL_STRIDE_M1_L2 = 10
CSR_TEMPORAL_STRIDE_M1_L3 = 11
CSR_SPATIAL_STRIDE_M0 = 12
CSR_SPATIAL_STRIDE_M1 = 13
CSR_BASE_PTR_M0 = 14
CSR_BASE_PTR_M1 = 15
CSR_START_STREAMER = 16
...
async def stream_tcdm_dut(dut):
    ...
    LOOP_COUNT_3 = TRANSFORMATION_PARAMS['strides'][-4]['bound']    # Outer-Most Loop
    ...
    TEMPORAL_STRIDE_M0_L3 = TRANSFORMATION_PARAMS['strides'][-4]['src'] * ALIGN_ELEMS
    ...
    TEMPORAL_STRIDE_M1_L3 = TRANSFORMATION_PARAMS['strides'][-4]['dst'] * ALIGN_ELEMS
    SPATIAL_STRIDE_M1 = 0       # Not used
    OFFSET = 8                  # Relieve bank confilct via a pre-computed offset
    BASE_PTR_M1 = NR_BANKS * math.ceil(LOOP_COUNT_0 * LOOP_COUNT_1 * LOOP_COUNT_2 * LOOP_COUNT_3 * ALIGN_ELEMS / NR_BANKS) + OFFSET
    # BASE_PTR_M1 = 128
    ...
    narrow_golden_list = snax_util.gen_rand_int_list(
        int(LOOP_COUNT_0 * LOOP_COUNT_1 * LOOP_COUNT_2 * LOOP_COUNT_3), MIN_VAL, 255
    )
    ...
    await snax_util.reg_write(dut, CSR_LOOP_COUNT_3, LOOP_COUNT_3)
    ...
    await snax_util.reg_write(dut, CSR_TEMPORAL_STRIDE_M0_L3, TEMPORAL_STRIDE_M0_L3)
    ...
    await snax_util.reg_write(dut, CSR_TEMPORAL_STRIDE_M1_L3, TEMPORAL_STRIDE_M1_L3)
    ...
    reg_val = await snax_util.reg_read(dut, CSR_TEMPORAL_STRIDE_M0_L3)
    snax_util.comp_and_assert(TEMPORAL_STRIDE_M0_L3, reg_val)
    ...
    reg_val = await snax_util.reg_read(dut, CSR_TEMPORAL_STRIDE_M1_L3)
    snax_util.comp_and_assert(TEMPORAL_STRIDE_M1_L3, reg_val)
    ...
    for i in range(LOOP_COUNT_3):
        for j in range(LOOP_COUNT_2):
            for k in range(LOOP_COUNT_1):
                for l in range(LOOP_COUNT_0):
                    read_stream_0 = int(dut.stream2acc_data_0_bits_o.value)
                    cocotb.log.info("[Read Test] Run the streamer and check if data are correct")
                    cocotb.log.info(">> Gold_list:     %s", narrow_golden_list[(i * TEMPORAL_STRIDE_M0_L3 + j * TEMPORAL_STRIDE_M0_L2 + k * TEMPORAL_STRIDE_M0_L1 + l * TEMPORAL_STRIDE_M0_L0) // ALIGN_ELEMS])
                    cocotb.log.info(">> Read_Stream_0: %s", read_stream_0)
                    snax_util.comp_and_assert(narrow_golden_list[(i * TEMPORAL_STRIDE_M0_L3 + j * TEMPORAL_STRIDE_M0_L2 + k * TEMPORAL_STRIDE_M0_L1 + l * TEMPORAL_STRIDE_M0_L0) // ALIGN_ELEMS], read_stream_0)
                    await snax_util.clock_and_wait(dut)            
    ...
    for i in range(LOOP_COUNT_0 * LOOP_COUNT_1 * LOOP_COUNT_2 * LOOP_COUNT_3):
    ...
    await snax_util.reg_write(dut, CSR_LOOP_COUNT_2, 1)
    await snax_util.reg_write(dut, CSR_LOOP_COUNT_3, LOOP_COUNT_0 * LOOP_COUNT_1 * LOOP_COUNT_2 * LOOP_COUNT_3)
    ...
    await snax_util.reg_write(dut, CSR_TEMPORAL_STRIDE_M0_L3, 1 * ALIGN_ELEMS)
        ...
        for j in range(LOOP_COUNT_2):
            for k in range(LOOP_COUNT_1):
                for l in range(LOOP_COUNT_0):
                    ...
                    cocotb.log.info(">> Gold_list:     %s", narrow_writer_golden_list[(i * TEMPORAL_STRIDE_M1_L3 + j * TEMPORAL_STRIDE_M1_L2 + k * TEMPORAL_STRIDE_M1_L1 + l * TEMPORAL_STRIDE_M1_L0) // ALIGN_ELEMS])
                    cocotb.log.info(">> Read_Stream_0: %s", read_stream_0)
                    # Streamed data should be consistent
                    snax_util.comp_and_assert(narrow_writer_golden_list[(i * TEMPORAL_STRIDE_M1_L3 + j * TEMPORAL_STRIDE_M1_L2 + k * TEMPORAL_STRIDE_M1_L1 + l * TEMPORAL_STRIDE_M1_L0) // ALIGN_ELEMS], read_stream_0)
                    await snax_util.clock_and_wait(dut)
...
def test_stream_tcdm(simulator, waves):
    ...
    streamer_cfg_file = "streamer_cfg_reshuffler_case5.hjson"
    ...
    module = "test_stream_tcdm_reshuffler_case5"
