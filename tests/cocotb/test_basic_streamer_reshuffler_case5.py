...
# found in ./util/cfg/streamer_cfg_reshuffler_case5.hjson
#
# Sequence of tests:
...
BASE_PTR_M1 = NUM_BANKS * math.ceil(LOOP_COUNT_0 * LOOP_COUNT_1 * LOOP_COUNT_2 * LOOP_COUNT_3 * ALIGN_ELEMS / NUM_BANKS) + OFFSET
        ...
        for j in range(LOOP_COUNT_2):
            for k in range(LOOP_COUNT_1):
                for l in range(LOOP_COUNT_0):
                    iter_count = i * LOOP_COUNT_2 * LOOP_COUNT_1 * LOOP_COUNT_0 + j * LOOP_COUNT_1 * LOOP_COUNT_0 + k * LOOP_COUNT_0 + l
...
def test_basic_streamer_reshuffler(simulator, waves):
    ...
    module = "test_basic_streamer_reshuffler_case5"
