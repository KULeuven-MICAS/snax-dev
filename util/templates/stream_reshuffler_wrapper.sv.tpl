...
//-------------------------------
module stream_reshuffler_wrapper # (
...
% endfor
  ...
  //-----------------------------
  // Reshuffler Accelerator
  //-----------------------------
  simple_reshuffler_wrapper #(
    .SpatPar          ( SpatPar                 ),
    .DataWidth        ( NarrowDataWidth         )
  ) i_simple_reshuffler_wrapper (
    //-------------------------------
    // Clocks and reset
    //-------------------------------
    .clk_i            ( clk_i                   ),
    ...
    // Accelerator ports
    //-------------------------------
    .data_i           ( stream2acc_data_0_bits  ),
    .data_valid_i     ( stream2acc_data_0_valid ),
    .data_ready_o     ( stream2acc_data_0_ready ),
    .data_o           ( acc2stream_data_0_bits  ),
    .data_valid_o     ( acc2stream_data_0_valid ),
    .data_ready_i     ( acc2stream_data_0_ready ),
    //-----------------------------
    // CSR control ports
    //-----------------------------
    // Request
