...
module stream_simd_wrapper # (
  ...
  parameter int unsigned AddrSelOffSet   = ${cfg["streamerCsrNum"]},
  parameter int unsigned RegCount 		   = ${cfg["streamerCsrNum"] + cfg["simdCsrNum"]},
...
% endfor
  ...
  //-----------------------------
  // PostProcessing SIMD Accelerator
  //-----------------------------
  SIMDTop i_SIMDTop (
    //-------------------------------
    // Clocks and reset
    ...
    // Accelerator ports
    //-------------------------------
    .io_data_input_i_bits    ( stream2acc_data_0_bits  ),
    .io_data_input_i_valid   ( stream2acc_data_0_valid ),
    .io_data_input_i_ready   ( stream2acc_data_0_ready ),
    .io_data_out_o_bits    ( acc2stream_data_0_bits  ),
    .io_data_out_o_valid   ( acc2stream_data_0_valid ),
    .io_data_out_o_ready   ( acc2stream_data_0_ready ),
    //-----------------------------
    // CSR control ports
    //-----------------------------
    // Request
