...
//-------------------------------
module stream_dev_reshuffler_wrapper # (
...
% endfor
  ...
  //-----------------------------
  dev_reshuffler_wrapper #(
    .SpatPar          ( SpatPar                 ),
    .DataWidth        ( NarrowDataWidth         )
  ) i_dev_reshuffler_wrapper (
    //-------------------------------
    // Clocks and reset
    //-------------------------------
    .clk_i            ( clk_i                   ),
    ...
    .z_o              ( acc2stream_data_0_bits  ),
    .z_valid_o        ( acc2stream_data_0_valid ),
    .z_ready_i        ( acc2stream_data_0_ready ),
    //-----------------------------
    // CSR control ports
    //-----------------------------
    // Request
